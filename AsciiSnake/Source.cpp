...
int main()
{
	...
	while (1)
	{
		...
		while (!bDead)
		{
			...
			// Game Logic
			// Update Snake Position, place new head at the front of the list in
			// the right direction
			...
			wsprintf(&screen[nScreenWidth + 5], L"WELCOME TO MY GAME, YOU SORRY SOULS... PREPARE TO LOSE XD                            SCORE: %d", nScore);
